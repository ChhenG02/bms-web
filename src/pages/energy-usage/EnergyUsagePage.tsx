 ...
 * EnergyUsagePage.tsx
 *
 * Energy usage report page for PATech – Pisnuk AutoTech.
 *
 * HOW TO CONNECT TO BACKEND:
 *   - Replace each constant in the "STATIC DATA" section with your API call.
 *   - e.g. const { data: FILTER_TABS } = useQuery(['filterTabs'], fetchFilterTabs)
...
/** Filter tabs shown at the top (e.g. period selectors) */
const FILTER_TABS: FilterTab[] = [
  { key: "today", label: "Today", color: "#4f74e8" },
  { key: "week", label: "This Week", color: "#4f74e8" },
  { key: "month", label: "This Month", color: "#4f74e8" },
  { key: "year", label: "This Year", color: "#4f74e8" },
];
