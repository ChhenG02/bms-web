...
function ProfilePage() {
  ...
  const handleSavePassword = () => {
    if (!passwords.current)
      return setPasswordError("Please enter current password");
    if (passwords.next.length < 6)
        ...
        <div style={{ marginTop: 8 }}>
          {!editingProfile ? (
            ...
            <div>
              ...
              >
                <Descriptions.Item label="Name (Latin)">
                  {profile.name}
                </Descriptions.Item>

                <Descriptions.Item label="Name (Khmer)">
                  {profile.nameKh}
                </Descriptions.Item>
            ...
            <div>
              ...
              <Row gutter={[32, 16]}>
                <Col xs={24} sm={12}>
                  <label style={labelStyle}>Name (Latin)</label>
                  <Input
                    value={editForm.name}
                    onChange={(e) =>
                      setEditForm({ ...editForm, name: e.target.value })
                    }
                    placeholder="Enter name in Latin characters"
                    size="large"
                    style={inputStyle}
                  />
                </Col>
                ...
                <Col xs={24} sm={12}>
                  <label style={labelStyle}>Name (Khmer)</label>
                  <Input
                    value={editForm.nameKh}
                    onChange={(e) =>
                      setEditForm({ ...editForm, nameKh: e.target.value })
          ...
          {!showChangePassword ? (
            ...
            <div>
              ...
              <Flex gap={12} justify="flex-end">
                ...
                >
                  {passwordSaved ? "Saved!" : "Save Password"}
                </Button>
              </Flex>
            </div>
          )}
